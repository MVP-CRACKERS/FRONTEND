...
export default function AdminPage() {
  ...
  }, [admin, search, status, paymentStatus, page]);
      ...
      <header className="bg-[#0F3D1E] text-white sticky top-0 z-30 shadow-md">
        <div className="max-w-[1400px] mx-auto px-4 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/MVP.png" alt="MVP Crackers" className="h-9 w-auto" />
            <span className="font-bold tracking-wide hidden sm:inline">ORDERS</span>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-sm text-white/70 hidden sm:inline">{admin.email}</span>
            <button
              onClick={logout}
              className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-3 py-2 rounded-lg text-sm font-bold transition-colors"
            >
